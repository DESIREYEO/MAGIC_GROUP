        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-10 text-sm">
            ...
            <div className="hidden md:flex items-center space-x-6">
              <a href="tel:+2252722263039" className="flex items-center space-x-2 hover:text-emerald-100 transition-colors">
              ...
              <a href="mailto:magicgroup.multiservices@gmail.com" className="flex items-center space-x-2 hover:text-emerald-100 transition-colors">
                ...
                <span>magicgroup.multiservices@gmail.com</span>
              </a>
            </div>
            ...
            <div className="flex items-center space-x-4 ml-auto">
              ...
              <a href="#" className="hover:text-emerald-100 transition-colors" aria-label="LinkedIn">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  <div className="w-37 h-37">
    <img src="/images/logosf.png" alt="MAGIC GROUP logo" className="w-full h-full object-contain" />
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link
                href="/contact"
                className="px-6 py-2.5 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold rounded-lg hover:from-emerald-700 hover:to-teal-700 transition-all transform hover:scale-105 shadow-md"
              >
                Contact
              </Link>
            </div>
            ...
            <div className="md:hidden py-4 border-t">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="block py-3 text-gray-700 hover:text-emerald-700 font-medium hover:bg-emerald-50 px-4 rounded-lg transition-all"
              ...
              <Link
                href="/contact"
                className="block mt-4 mx-4 px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold rounded-lg hover:from-emerald-700 hover:to-teal-700 transition-all text-center"
                onClick={() => setIsMenuOpen(false)}
              >
                Contact
              </Link>
              ...
              <div className="mt-4 pt-4 border-t space-y-3 px-4">
                <a href="tel:+2252722263039" className="flex items-center space-x-2 text-sm text-gray-600">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <span>(+225) 27 22 26 30 39</span>
